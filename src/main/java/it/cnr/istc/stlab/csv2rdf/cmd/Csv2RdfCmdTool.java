...
public class Csv2RdfCmdTool {
    ...
    public static void main(String[] args) {
        ...
        optionBuilder = Option.builder(INPUT_OPTION);
        Option inputOption = optionBuilder.argName("file")
                .desc("The name of the CSV input file.")
                .hasArg()
                .required(false)
                .longOpt(INPUT_OPTIONS_LONG)
                .build();
        ...
        if (commandLine != null) {
            ...
            String csv = commandLine.getOptionValue("i");
